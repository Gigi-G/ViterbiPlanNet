...
def get_args(description='whl'):
    ...
    parser.add_argument('--saved_path', default='./logs/', type=str, help='descriptions dir')
    parser.add_argument('--checkpoint_root',
                        type=str,
                        default='checkpoint',
                        help='checkpoint dir root')
    parser.add_argument('--diffusion_checkpoint_root',
                        type=str,
                        default='',
                        help='checkpoint root for diffusion model (defaults to --checkpoint_root)')
    parser.add_argument('--mlp_checkpoint_root',
                        type=str,
                        default='',
                        help='checkpoint root for task MLP model (defaults to --checkpoint_root + _mlp)')
    ...
    parser.add_argument('--horizon',
                        ...
                        default=3, 
                        help='')
    parser.add_argument('--horizon_test',
                        type=int,
                        default=3, 
                        help='')
    ...
    # Argument needed to work with the SCHEMA dataloader
    parser.add_argument('--features_dir',
                        type=str,
                        default='/l/users/ravindu.nagasinghe/KEPP/datasets/CrossTask_assets/features',
                        help='Path to the directory containing the features')
    parser.add_argument('--train_json', 
                        type=str,
                        default='/l/users/ravindu.nagasinghe/KEPP/datasets/CrossTask_assets/data_lists/train_data_list.json',
                        help='Path to the training JSON file')
    parser.add_argument('--valid_json',
                        type=str,
                        default='/l/users/ravindu.nagasinghe/KEPP/datasets/CrossTask_assets/data_lists/val_data_list.json',
                        help='Path to the validation JSON file')
    parser.add_argument('--aug_range',
                        type=int,
                        default=0,
                        help='Range for data augmentation')
